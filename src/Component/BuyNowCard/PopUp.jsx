    ...
    return (
        ...
        >
            <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 relative">
                <svg xmlns="http://www.w3.org/2000/svg" onClick={() => setPopup(false)}
                ...
                <div className="my-8 text-center">
                    ...
                    <h4 className="text-xl text-gray-800 font-semibold mt-4">Order successfully accepted!</h4>
                ...
                <Link to='/'>
                    <button type="button"
                        ...
                        className="px-5 py-2.5 w-full rounded-lg text-white text-sm border-none outline-none bg-green-800 hover:bg-green-700">Got it</button>
                </Link>
            </div>
        </div>
    )
